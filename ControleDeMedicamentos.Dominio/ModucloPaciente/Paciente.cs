...
namespace ControleDeMedicamentos.Dominio.ModucloPaciente
{
    public class Paciente : EntidadeBase<Paciente>
    {
        ...
        public override void AtualizarRegistro(Paciente registroAtualizado)
        {
            ...
            Cartao = registroAtualizado.Cartao;
        ...
        public override string Validar()
        {
            ...
            if ( string.IsNullOrWhiteSpace(Cartao))
                erros += "O campo 'CartãoSUS' é obrigatório.\n";
            else if (!Regex.IsMatch(Cartao, @"^\d{15}$"))
                erros += "O campo 'CartãoSUS' deve conter 15 dígitos.\n";
